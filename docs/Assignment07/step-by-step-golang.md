...
The `CollectFine` of the FineCollectionService uses a  hard coded `FineCalculator` implementation to calculate the fine for a certain speeding violation (check out the code). 
